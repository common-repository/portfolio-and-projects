...
class Wp_Pap_Admin {
	...
	function wp_pap_register_menu() {
		...
		add_submenu_page( 'edit.php?post_type='.WP_PAP_POST_TYPE, __( 'Upgrade To Premium - Portfolio and Projects', 'portfolio-and-projects' ), '<span style="color:#ff2700">'.__( 'Upgrade To Premium', 'portfolio-and-projects' ).'</span>', 'manage_options', 'wp-pap-premium', array( $this, 'wp_pap_premium_page' ) );
	}
